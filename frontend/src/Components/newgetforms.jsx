...
export default function NewFormsList({ }) {
    ...
    const handledeleteQuestion = async (questionId) => {
        try {
            setLoading(true);
            const response = await axios.post(`http://localhost:3000/forms/:formId/questions/${questionId}/delete`);
            setSelectedForm(response.data.form);
            setQuestionTitle("");
    ...
    return (
        <div className="gorkem-sidebar-container">
            <div className="gorkem-sidebar">
                ...
                <button className="gorkem-sign-button btn-lg">Sign</button>
            </div>
                                                        ...
                                                        <div className="mycard formCard" onClick={() => handleFormSelect(form._id)}>
                                                            <div className='myCardRow'>
                                                                ...
                                                                <div className='mybtn-group'>
                                                                    ...
                                                                    <button onClick={() => handleEditForm(form.formId)} type='button' className='btn btn-outline-secondary'>
                                                            ...
                                                            <div key={question._id} className="col-md-6 mb-3">
                                                                <div className=" card border-light mb-3">
                                                                    <div className="card-body leftborder">
                                                                        ...
                                                                        <br />
                                                                        <button onClick={() => handledeleteQuestion(selectedForm.formId, selectedForm.questionId)} type='button' className='btn btn-outline-secondary'>
